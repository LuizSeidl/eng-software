...
Repositório com materiais da minha graduação em Engenharia de Software.

## 📁 Estrutura

Cada semestre contém pastas por disciplina, organizadas em:

- `aulas/` — anotações e resumos
- `simulados/` — simulados e provas anteriores
- `laboratorio/` — exercícios práticos de laboratório
